...
{
	  Camera cam("/Users/JC/Desktop/tests/TownCentreXVIDWEB.m4v");
...
//    const char* bta_name = "trajet.db";
//    char*       bta_data_name ="trajet_name.db";
//    char*       track_name = NULL;
//    //char*       comment_name = NULL;
//    char*       FGTrainFrames = "100";
//    char*       log_name = "./log_track.log";
//    char*       savestate_name = NULL;
//    char*       loadstate_name = NULL;
//    const char* bt_corr = "PostProcRes";
...
//    avi_name = "/Users/JC/Desktop/tests/TownCentreXVIDWEB.m4v";
//    /* Create source video: */
//    if(avi_name)
//        pCap = cvCaptureFromFile("/Users/JC/Desktop/tests/TownCentreXVIDWEB.m4v");
//
//    if(pCap==NULL)
//    {
//        printf("Can't open %s file\n",avi_name);
//        //return -1;
//        pCap = cvCaptureFromCAM(-1);
//    }
//
//
//    {   /* Display parameters: */
